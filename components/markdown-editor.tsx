...
export function MarkdownEditor({ 
  ...
  return (
    <div className={cn(
      'w-full border rounded-lg overflow-hidden backdrop-blur-md bg-card/80',
      ...
      <div className="flex" style={{ height: isFullscreen ? 'calc(100vh - 60px)' : height }}>
        ...
        <div className={cn(
          ...
          <textarea
            ...
            className="flex-1 w-full p-4 bg-transparent border-none outline-none resize-none font-mono text-sm leading-relaxed"
            style={{ minHeight: '100%' }}
          />
        </div>
            ...
            <div className="p-4 prose prose-sm max-w-none dark:prose-invert">
              <ReactMarkdown
                ...
                components={{
                  ...
                  blockquote({ children }) {
                    return (
                      <blockquote className="border-l-4 border-primary bg-muted/50 pl-4 py-2 rounded-r italic">
                        {children}
                      </blockquote>
                    );
                  },
...
export function SimpleMarkdownEditor({ value, onChange, className }: {
  value: string;
  onChange: (value: string) => void;
  className?: string;
}) {
